...
let td = `{
    ...
    "properties": {
        "temperatura": {
            "type": "integer",
            "forms": [{
                "href": "mqtt://localhost:1883/AireAcondicionado/properties/temperatura"
            }]
        }
    },
    "actions" : {
        "OnOff": {
            "forms": [
                {"href": "mqtt://localhost:1883/AireAcondicionado/actions/OnOff"}
            ]
        },
        "incrementar": {
            "forms": [
                {"href": "mqtt://localhost:1883/AireAcondicionado/actions/incrementar"}
            ]
        },
        "decrementar": {
            "forms": [
                {"href": "mqtt://localhost:1883/AireAcondicionado/actions/decrementar"}
            ]
        },
        "leerTemperatura": {
            "forms": [
                {"href": "mqtt://localhost:1883/AireAcondicionado/actions/leerTemperatura"}
            ]
        }
    }, 
    "events": {
        "estadoTemperatura": {
            "type": "integer",
            "forms": [
                {"href": "mqtt://localhost:1883/AireAcondicionado/events/estadoTemperatura"}
            ]
        } 
    } 
}`;
